...
| 2026-03-31 | 4 | 6 | 4 | 0 | A10 (Dial/Reap/Shade) + feedback too generous (Trace 52→45) | 6 | (1) A10 kills all visible small-grid games. (2) Hidden info requires info_per_guess ≈ log2(answers) for 4-6 guess tension. Trace gave 18 bits/guess for 10 bits needed → too easy. (3) NP-hardness only matters at SCALE — 9-node graph coloring is trivial. Next: hidden-info game calibrated for information-theoretic tension (Wordle ratio: ~8 bits/guess for ~13 bits answer). |
